...
import {
  ...
  type V1_QueryServiceExecutionBuilder,
  ...
  implements DSL_Mapping_PureProtocolProcessorPlugin_Extension
{
  ...
  override V1_getExtraV1_QueryServiceExecutionBuilder(): V1_QueryServiceExecutionBuilder[] {
    return [
      (
        ...
        if (queryExec instanceof QueryDataSpaceExecutionContextInfo) {
          ...
          if (dataSpaceEntity) {
            const content =
              dataSpaceEntity.content as PlainObject<V1_PackageableElement>;
