...
import {
  TDSResultModifierValueSpecificationBuilder,
  TypedResultModifierValueSpecificationBuilder,
  appendResultSetModifier,
  type ResultModifierValueSpecOptions,
} from '../result-modifier/ResultModifierValueSpecificationBuilder.js';
