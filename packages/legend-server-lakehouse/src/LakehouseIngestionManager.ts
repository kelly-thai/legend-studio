...
import { LakehouseIngestDiscoveryServerClient } from './LakehouseIngestDiscoveryServerClient.js';
import { LakehouseIngestDeploymentServerClient } from './LakehouseIngestDeploymentServerClient.js';
import {
...
export class LakehouseIngestionManager {
  private ingestDiscoveryServerClient: LakehouseIngestDiscoveryServerClient;
  private ingestDeploymentServerClient: LakehouseIngestDeploymentServerClient;
  ...
  constructor(
    ...
    this.ingestDiscoveryServerClient = new LakehouseIngestDiscoveryServerClient(
      discoveryUrl,
    );
    this.ingestDeploymentServerClient =
      new LakehouseIngestDeploymentServerClient(defaultServer);
